...
<%
		...
		if("sas".equals(dl)){
	 	...
	 	String sql = "select ID_SPCX DM,SUBSTRING(ID_AJLX,3,1) DM2,"+column+" NUM from FACT_SJC_SPCX "
	 				+ " where "
	 				+ cond
 					+ " and ID_YWCB like '"+fjm+"%' "
 					//+ " AND ID_AJLX IN ('1011','1012','1013','2021','2022','2023','6031','6032','6033') "
 					+ " group by ID_SPCX,SUBSTRING(ID_AJLX,3,1) ";
 ...
 %>
option = {
     title : {show:true,x:'center',text: '<%=mc %>审判程序<%=name %>组成情况(<%=total %>)',
	     textStyle:{
		    fontSize: 26,
		    fontWeight: 'bolder',
		    color: '#000000',
