...
function doFc(baseid,fydm,kssj,jssj,ajlx,spcx){
...
function drawBar(nd,dl,dm,fjm,mc,ajlx){
	loadOption(contextPath+"/webapp/spxt/hzqk/hzdt_bar.jsp",{
		'nd':nd,
		'dl':dl,
		'dm':dm,
		'fjm':fjm,
...
function drawLine(nd,dl,dm,fjm,mc,ajlx){
	loadOption(contextPath+"/webapp/spxt/hzqk/hzdt_line.jsp",{
		'nd':nd,
		'dl':dl,
		'dm':dm,
		'fjm':fjm,
...
function loadData(flag){
	...
	if(citydm.length < 6){
		...
		//地图
		loadOption(contextPath+"/webapp/spxt/hzqk/hzdt_map.jsp",{
			'nd':nd,
			'dl':dl,
			'dm':citydm,
			'fjm':fjm,
	...
	loadOption(contextPath+"/webapp/spxt/hzqk/hzdt_data.jsp",{
		'nd':nd,
		'dl':dl,
		'dm':citydm,
		'fjm':fjm,
	...
	loadOption(contextPath+"/webapp/spxt/hzqk/hzdt_pie1.jsp",{
		'nd':nd,
		'dl':dl,
		'dm':citydm,
		'fjm':fjm,
	...
	loadOption(contextPath+"/webapp/spxt/hzqk/hzdt_pie2.jsp",{
		'nd':nd,
		'dl':dl,
		'dm':citydm,
		'fjm':fjm,
...
function changeColor(value){
	loadOption(contextPath+"/webapp/spxt/hzqk/hzdt_map_color.jsp",{
		'nd':nd,
		'dl':dl,
		'dm':citydm,
		'fjm':fjm,
	 ...
	 <div class="map_panel">
	 	 <table style="margin:5px;" cellpadding="0" cellspacing="0" border="0">
	 	 	...
	 	 	<tr>
	 	 		...
	 	 		<!--  -->
	 	 		<td class="tab_center">
	 	 			<div style="position: absolute;left: 190px;top:143px;z-index:99999;">
	 	 				<select  id='nd' style='width:60px;height: 22px' onchange='changeNd(this.value)'>
	 	 					<!-- 
	 	 					<option value='2015' selected="selected">2015</option>
	 	 					<option value='2014'>2014</option>
		                    <option value='2013'>2013</option>
		                     -->
		                     <%=CalendarUtil.getNdOption() %>
		                </select>
	 	 		...
	 	 		<!--  
	 	 		<td class="tab_center">
		 	 		<table align="left" style="margin:0px;" cellpadding="0" cellspacing="0" border="0">
		 	 			...
		 	 			<tr height='32'>
		 	 				<td align='left'>
	                        	...
	                        	&nbsp;
	                        	<input onclick="changeDl('sas');" id='sas' type="radio" name="dl"  value="1" checked='checked' />收案
	                        	<input onclick="changeDl('jas');" id='jas' type="radio" name="dl" value="2" />结案
	                        	<input onclick="changeDl('wjs');" id='wjs' type="radio" name="dl"  value="3" />未结
							</td>
		 	 			</tr>
